    ...
    <div id="main_banner" class="carousel slide">
        ...
        <div class="carousel-image">
            ...
            <div class="banner-text"
                ...
                <a href="#" class="text-uppercase" @click.prevent="buyNowFromBanner(images[imageIndex].product_id)">buy
                    now</a>
            </div>
        </div>
    </div>
    ...
    data() {
        return {
            images: [
                ...
                {
                    src: 'assets/main_banner4.jpg',
                    description: 'the best smartphones',
                    lure: 'super price',
                    placeLeft: false,
                    product_id: 6
                },
