    ...
    <div class="single-product-view">
        ...
        <div class="main-look">
            <div class="main-image">
                <img :src="'/'+bigImage" alt="this place for image" ref="mainImage">
            ...
            <div class="descriptions">
                ...
                <div class="take-params">
                    ...
                    <div class="color-choose picker">
                        <label>Color</label>
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="dropdownColor"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                {{ colorOption }}
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li v-for="(color, index) in options"
                                    :key="color.id"
                                    @click="colorPicked(color, index)"><p class="dropdown-item">{{ color.name }}</p>
                                </li>
                            </ul>
                        </div>
                    </div>
