    ...
    <div class="sorting-the">
        ...
        <div class="options">
            <div class="choose">
                <label>Sort By:</label>
                <div class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="dropdownSort" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        {{ sortOption }}
                    </button>
            ...
            <div class="choose">
                <label>Show:</label>
                <div class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="dropdownShow" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        {{ showOption }}
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
